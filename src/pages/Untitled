      ...
      <div className="w-full max-w-[480px]">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-sm" style={{ color: "#6B7280" }}>Log in to your Digital Ascension Group account.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: NAVY }}>Email address</label>
              <input
                type="email"
                value={form.email}
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-sm font-medium" style={{ color: NAVY }}>Password</label>
                <a href="#" className="text-xs font-medium hover:underline" style={{ color: "#0D9488" }}>Forgot password?</a>
              </div>
              <input
                type="password"
                value={form.password}
